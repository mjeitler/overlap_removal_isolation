...
hist_dPhidEta_mu_jet = hfile.Get("hist_dPhidEta_mu_jet")
hist_dPhidEta_eg_jet = hfile.Get("hist_dPhidEta_eg_jet")
...
ROOT.gPad.SetLogy(0)
#hist_dR_mu_jet.Draw()
hist_dPhidEta_mu_jet.Draw('colz')
pad.cd(3)
ROOT.gPad.SetLogy(0)
hist_dR_mu_jet.Draw()
ROOT.gPad.Update()
...
ROOT.gPad.SetLogy(0)
#hist_dR_eg_jet.Draw()
hist_dPhidEta_eg_jet.Draw('colz')
pad.cd(4)
ROOT.gPad.SetLogy(0)
hist_dR_eg_jet.Draw()
